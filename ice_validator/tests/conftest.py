...
def make_timestamp():
    """
    :return: String make_iso_timestamp in format: 2019-01-19 10:18:49.865000 Central Standard Time
    """
...
def collect_errors(r_id, collection_failures, test_result):
    ...
    """
    if r_id:
        selector = lambda x: r_id in req_ids(x)
    else:
        selector = lambda x: not req_ids(x)
