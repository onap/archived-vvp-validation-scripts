...
def get_defined_parameter_type(heat_parameters, parameter):
    if parameter in heat_parameters:
        return nested_dict.get(heat_parameters, parameter, "type")
    return None  # parameter is not defined in parameter section
