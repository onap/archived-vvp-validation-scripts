...
TEMPLATE_FILE = "{}/data/base_template.yaml".format(
    os.path.dirname(os.path.abspath(__file__))
)
TEMPLATE_ENV = "{}/data/base_template.yaml".format(
    os.path.dirname(os.path.abspath(__file__))
)
...
def test_network_name(tmpdir):

    network_name = "oam_net_id"
    network_present = False
    preload = Preload("vnf_name", TEMPLATE_FILE, str(tmpdir), preload_format="grapi")
